...
%\begin{center}
  \begin{tabular}{l}
      PhD student at ETH Zurich with strong background in Genetics,\\
...
\hspace{-2mm}\begin{tabular}{r!{\myline}p{14cm}}
        ...
        \mydate{Jun 2014}                   &   Bachelor degree in \textbf{Computer Informatics}\\
                                            &   Shumen University, Bulgaria\\
                                            &   \small\textcolor{darkgreen}{\,\,$\uparrow$\,transferred because of an administrative ban to enter Russia}\\
...
\hspace{0mm}\begin{tabular}{r!{\myline}p{14cm}}
        % \multicolumn{2}{c}{}\\
        \mydate{Jun 2016 ---}       &   Internship on modern biotech technologies\\
        \mydate{Mar 2017}                &   \comment{Genome assemblers, Single-cell transriptomics, T-cell receptor reconstruction, Machine learning}\\
                                    &   \textit{supervised by Prof. Martin Vechev, \href{http://www.srl.inf.ethz.ch/}{Software Reliability Lab}, ETH Zurich}\\
                                    &   \textit{collaborating with PD Dr. Emmanuella Guenova, \href{http://www.dermatologie.usz.ch/forschung/Seiten/forschungsgruppen.aspx}{Dermatology Clinic}, University of Zurich}\\
...
\hspace{0mm}\begin{tabular}{r!{\myline}p{14cm}}
        ...
        \mydate{now}                &   \textit{Google Zurich} \comment{big data and pipelines}\\
\end{tabular}
}  % end of Industry
