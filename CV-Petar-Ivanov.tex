...
\begin{center}
  \begin{tabular}{c}
      ...
      Loves teaching and communicating science. Worked as a Software engineer at Google.\\
    \end{tabular}
\end{center}
}  % end of Summary
...
\hspace{-2mm}\begin{tabular}{r!{\myline}p{14cm}}
        ...
        \bracketcomment{interrupted by visa issues}
                                            ...
                                            &   \small\textcolor{darkgreen}{\,\,$\downarrow$\,transferred because of an administrative ban to enter Russia}\\
...
\hspace{0mm}\begin{tabular}{r!{\myline}p{14cm}}
        ...
        \mydate{Now}                &   \comment{Genome assemblers, Single-cell transriptomics, T-cell receptor reconstruction, Machine learning}\\
...
% \setlength{\parindent}{1cm}
        ...
        Enjoying {\wide hiking, biking, dancing, paragliding and running}
