...
\hspace{0mm}\begin{tabular}{r!{\myline}p{14cm}}
        %\multicolumn{2}{c}{}\\
  \mydate{Nov 2013 ---}      &  High-school students trainer for informatics competitions \comment{sketched an algorithmic textbook}\\
                \mydate{now} &  \textbf{Mathematics and Informatics Private School ``A\&B''}, Bulgaria\\ % (\href{http://ab-bg.com/}{ab-bg.com})\\

        \multicolumn{2}{c}{}\\
        \mydate{Nov 2013 ---}      &  \textit{Technical Assistant of online course of bioinformatics on} \textbf{\href{https://www.coursera.org/course/bioinformatics}{Coursera}} \\
  \mydate{Jan 2014} &  supervised by Dr. Pavel Pevzner from University of California, San Diego\\

        \multicolumn{2}{c}{}\\
        \mydate{Jul 2013 ---}      &  \textit{Software Developer of a new feature in \href{http://bioinf.spbau.ru/spades}{SPAdes}} \bracketcomment{open source genome assembler} \comment{\href{http://pesho.info/wp-content/uploads/chimeras-final.pdf}{presentation}}\\
        \mydate{Aug 2013} &  supervised by Dr. Pavel Pevzner, \href{http://bioinf.spbau.ru/}{\textbf{Algorithmic Biology Lab} }\\
