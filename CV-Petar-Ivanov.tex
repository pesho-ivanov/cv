...
\begin{center}
  \begin{tabular}{c}
      ...
      Winner of multiple programming competitions. Did Bio\&IT-oriented research internships.\\
...
\hspace{0mm}\begin{tabular}{r!{\myline}p{14cm}}
        ...
        \mydate{now}                &   \textit{Google Zurich} \comment{big data, messy pipelines and loads of code}\\
\end{tabular}
...
\hspace{0mm}\begin{tabular}{r!{\myline}p{14cm}}
        ...
        \mydate{Sep 2012 ---}       &   Microbiological models designer
                                        \comment{microcin (antibiotic) modelling \href{https://docs.google.com/document/d/1tNkXLaWY3ooA4MEnrbrL2_DOpOaiTlLoFblwzKFZdy0/edit?usp=sharing}{[Summary]}}\\
        ...
        \mydate{Aug 2012}           &   \comment{insisted on my own topic on virus-bacteria interaction (didn't work) \href{https://docs.google.com/document/d/1tNkXLaWY3ooA4MEnrbrL2_DOpOaiTlLoFblwzKFZdy0/edit?usp=sharing}{[Summary]}}\\
...
\hspace{0mm}\begin{tabular}{r!{\myline}p{14cm}}
        ...
        \multicolumn{2}{c}{}\\
        \mydate{Sep 2008 ---}       &   Author of problems for Bulgarian Tournaments in Informatics\\
                                        % \comment{4 such competitions}\\
        \mydate{Jun 2009,}          &   Lecturer at National Informatics Camps\\
                                        % \comment{3 such camps}\\
        \mydate{2013 --- 2014}      &   \textit{National Committee in Informatics, Bulgarian Ministry of Education}\\
\end{tabular}
...
% \setlength{\parindent}{1cm}
        ...
        Relaxes by {\wide hiking, biking, dancing, paragliding and running}
