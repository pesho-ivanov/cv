...
\begin{center}
  \begin{tabular}{c}
    A new grad with solid background in algorithms and data structures.\\
    Winner of multiple programming competitions. Did several internships in bioinformatics.\\
  ...
  %\textbf{Faculty of Mathematics and Informatics}
	...
	\multicolumn{2}{c}{}\\
        \mydate{Sep 2000 --- Jun 2008}      &   \textbf{Mathematics and Physics class}
                                                \comment{award for most scientific achievements of my year}\\
...
\hspace{0mm}\begin{tabular}{r!{\myline}p{14cm}}
        ...
        \mydate{Aug 2012}           &   \comment{proposed my own topics on 1) virus-bacteria interaction and 2) microcin antibiotics: \href{https://docs.google.com/document/d/1tNkXLaWY3ooA4MEnrbrL2_DOpOaiTlLoFblwzKFZdy0/edit?usp=sharing}{[Summary]}}\\
...
\hspace{0mm}\begin{tabular}{r!{\myline}p{14cm}}
        ...
        \mydate{now}                &   \textit{Mathematics and Informatics Private School ``A\&B''}, Shumen, Bulgaria\\ % NA http://ab-bg.com/
...
%	\setlength{\parindent}{1cm}
        ...
        Founded a project for describing educational systems &
          ...
          Love to {\wide hike, bike, orienteer} and to {\wide run long}
