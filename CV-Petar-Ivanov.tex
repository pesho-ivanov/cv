...
\vspace{2mm}
%  \begin{tabular}{c}
PhD student at ETH Zurich in algorithmic computational biology.\\
Worked at Google and prepared students for olympiads in informatics.\\
Interested in cooperative structures.\\
%    \end{tabular}
%\end{center}
}  % end of Summary
...
\begin{tabular}{r!{\myline}p{14cm}}
        \mydate{Apr 2017 --- Nov 2022}      &   PhD student on \textbf{Reliable Computational Biology}\\
                                 (expected) &   Thesis: \textit{Optimal sequence alignment using A*}\\
                                            &   Past project: Clonality language for analysis of lymphocyte single-cell RNA data\\
                                            &   Teaching assistent of one course per semester\\
                                            & \\
