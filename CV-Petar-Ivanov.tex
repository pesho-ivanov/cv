...
\hspace{0mm}\begin{tabular}{r!{\myline}p{14cm}}
  \textsc{2009 --- 2014}     &  Specialist degree {\small(joint Bachalor \& Master)} in \textsc{Applied Mathematics and Informatics}\\
...
%	Scientifically interested in \textsc{Computer Vision, Computational Geometry, Bioinformatics, Machine Learning, Genetic Algorithms}\interestsSpace	
        Interested in Bioinformatics, Combinatorial Optimization, Computer Vision, Computational Geometry, Genetics, Machine Learning, Robotics\interestsSpace
