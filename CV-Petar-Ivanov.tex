...
\begin{wrapfigure}{r}{4.5cm}
	...
	\setlength\fboxrule{0.1pt}
        \vspace{-50pt}\fbox{\includegraphics[width=33mm]{PetarIvanov.jpg}}
\end{wrapfigure}
...
\hspace{0mm}\begin{tabular}{r!{\myline}p{14cm}}
	...
	\mydate{Sep 2012 ---}       &   Microbiological models designer
                                        \comment{mainly on microcin antibiotic model}\\
...
\section{Hobbies and Other}
\hspace{2mm}\begin{tabular}{@{•\enskip}ll}
%	\setlength{\parindent}{1cm}
        Speaks \textbf{English}, \textbf{Russian} and \textbf{Bulgarian} &\\
        ...
        Founded a project for describing educational systems &
          ...
          Loves {\wide hiking, biking, orienteering} and {\wide running}
