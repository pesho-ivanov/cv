...
\begin{wrapfigure}{r}{5cm}
          \vspace{-35pt}\includegraphics[width=40mm]{PetarIvanov2015.jpg}
\end{wrapfigure}
...
\hspace{4mm}\begin{tabular}{rl}
        ...
        \minorcolor{born:} & \textsc{29 May 1989}, Shumen, Bulgaria\\
        ...
        \minorcolor{wiki:} & \href{https://pesho-ivanov.github.io/}{pesho-ivanov.github.io}\\
        \minorcolor{twitter:} & \href{https://twitter.com/peshotrie}{peshotrie}\\
\end{tabular}
\bigskip
...
& PhD from ETH Zurich, thesis: \textit{Optimal sequence alignment using A*}.\\
...
\begin{tabular}{r!{\myline}p{14cm}}
        \mydate{July 2023 --- \textit{now}} &   Postdoc in genome sequence analysis, Pennsylvania State University, repo: \href{https://github.com/pesho-ivanov/sweepmap}{sweepmap}\\
                                            &   \textit{Prof. Paul Medvedev's Algorithmic Bioinformatics group} (\href{https://medvedevgroup.com/}{medvedevgroup.com})\\

        \multicolumn{2}{c}{}\\
        \mydate{Apr 2017 --- Apr 2023}      &   PhD student, thesis \href{https://www.research-collection.ethz.ch/handle/20.500.11850/646589}{\textit{Optimal sequence alignment using A*}}\\
                                            &   Repos: \href{https://github.com/eth-sri/astarix}{AStarix}, \href{https://github.com/pesho-ivanov/minSH}{minSH}, \href{https://github.com/RagnarGrootKoerkamp/astar-pairwise-aligner}{astar-pairwise-aligner}\\
                                            &   \textit{Prof. Martin Vechev's} Secure, Reliable, and Intelligent Systems Lab (\href{https://www.sri.inf.ethz.ch/people/pesho}{sri.inf.ethz.ch})\\

        \multicolumn{2}{c}{}\\
        \mydate{Apr 2015 --- Feb 2017}      &   Master degree in Software Engineering \bracketcomment{extra-mural}, Shumen University, Bulgaria\\
                                            &   Thesis: \textit{Framework for Genomic Reconstruction Algorithms}\\

        \multicolumn{2}{c}{}\\
        \mydate{Jun 2014}                   &   Bachelor degree in Informatics, Shumen University, Bulgaria\\
                                            &   \small\textcolor{darkgreen}{\,\,$\uparrow$\,interrupted due to Russian visa issues}\\
        \mydate{Sep 2009 --- Jun 2013}      &   Specialist degree in Applied Mathematics and Informatics, Moscow State University\\
...
%                                            &   Yandex School of Data Mining, Moscow, Russia\\
                                            ...
                                            &   \small\textcolor{darkgreen}{\,\,$\uparrow$\,transferred to Moscow State University}\\
        \mydate{Sep 2008 --- Jun 2009}      &   Bachelor degree in Computer science, Sofia University, Bulgaria\\
                                                %\textbf{Faculty of Mathematics and Informatics},
...
\vspace{-2mm}\hspace{0mm}\begin{tabular}{r!{\myline}p{14cm}}
        \mydate{Sep 2011 --- Jun 2013}      &   Master degree \bracketcomment{not accredited} in Bioinformatics
                                                \comment{+ taught algorithms to biologists}\\
...
\begin{tabular}{r!{\myline}p{14cm}}
        % \multicolumn{2}{c}{}\\
        \mydate{Jun 2016 ---}       &   \textit{Clonality language for analysis of lymphocyte single-cell RNA data} (\href{https://github.com/pesho-ivanov/celldive}{repo link})\\
        \mydate{Mar 2017}           &   \textit{Prof. Martin Vechev, \href{http://www.srl.inf.ethz.ch/}{Software Reliability Lab}, ETH Zurich}\\
                                    &   \textit{MD Emmanuella Guenova, \href{http://www.dermatologie.usz.ch/forschung/Seiten/forschungsgruppen.aspx}{Dermatology Clinic}, University of Zurich}\\
        ...
        \mydate{Aug 2012}           &   \comment{virus-bacteria interaction \href{https://docs.google.com/document/d/1tNkXLaWY3ooA4MEnrbrL2_DOpOaiTlLoFblwzKFZdy0/edit?usp=sharing}{[Summary]}}\\
...
\mysect{Publications}{
\vspace{2mm}
\begin{tabular}{r!{\myline}l}
        & Exact global alignment using A* with chaining seed heuristic and match pruning\\
        & R. Groot Koerkamp and \textbf{P. Ivanov} (equal contribution)\\
        & \textit{Oxford Bioinformatics 2024}\\

        \multicolumn{1}{c}{}\\
        & Fast and Optimal Sequence-to-Graph Alignment Guided by Seeds\\
        & \textbf{P. Ivanov}, B. Bichsel, M. Vechev\\
        & \textit{International Conference on Research in Computational Molecular Biology (RECOMB) 2022}\\
...
\vspace{-2mm}
\hspace{3.5mm}\begin{tabular}{r!{\myline}p{14cm}}
...
% \setlength{\parindent}{1cm}
        ...
        Editing \href{https://en.wikipedia.org/wiki/User:Cheater_no1}{wikipedia}\\
        {\wide Running} %hiking, biking, dancing, paragliding and running}
              & \comment{42.195km~in~3:43h, \href{http://probeg.org/card.php?id=273}{Zelenograd, Russia, Dec 2011} }\\
              \multicolumn{1}{l}{} & \multicolumn{1}{l}{ \comment{100km~in~13:19h, \href{http://www.vitosha100km.bg/2011/}{Vitosha mountain, Bulgaria, 2012} } }\\
        Flying & \comment{\textsc{speedfly, acro-paragliding, cross-country pg, skydive}}\\
