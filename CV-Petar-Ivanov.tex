...
\hspace{-2mm}\begin{tabular}{r!{\myline}p{14cm}}
  ...
  %\textbf{Faculty of Mathematics and Informatics}
	...
	\textsc{Sep 2008 --- Jun 2009}     &  Bachelor degree in \textbf{Computer science}\\
        {\small\textit{(moved in Moscow University)}} &  %\textbf{Faculty of Mathematics and Informatics},
...
\hspace{0mm}\begin{tabular}{r!{\myline}p{14cm}}
        %\multicolumn{2}{c}{}\\
  \textsc{Nov 2013 ---}      &  \textit{Training high-school students for informatics competitions} \comment{sketched an algorithmic textbook}\\
                \textsc{now} &  \textbf{Mathematics and Informatics Private School ``A\&B''}, Bulgaria\\ % (\href{http://ab-bg.com/}{ab-bg.com})\\

        \multicolumn{2}{c}{}\\
        \textsc{Nov 2013 ---}      &  \textit{Technical Assistant of online course of bioinformatics \href{https://www.coursera.org/course/bioinformatics}{on Coursera}} \\
  \textsc{Jan 2014} &  supervised by Dr. Pavel Pevzner from University of California, San Diego\\

        \multicolumn{2}{c}{}\\
        \textsc{Jul 2013 ---}      &  \textit{Software Developer of a new feature in \href{http://bioinf.spbau.ru/spades}{SPAdes}, open source genome assembler --- \href{http://pesho.info/wp-content/uploads/chimeras-final.pdf}{presentation}}\\
        \textsc{Aug 2013} &  supervised by Dr. Pavel Pevzner, \href{http://bioinf.spbau.ru/}{\textbf{Algorithmic Biology Lab} }\\
...
\hspace{2.5mm}\begin{tabular}{rp{14cm}}
  Languages:      &  \textbf{C\,/\,C++ (STL)}, Python (NumPy, SciPy, MatPlotLib), Ruby, MATLAB, Java\\
        Technologies:   &  Unix, Bash, Vim, Git, %HTML\,/\,CSS, 
  {\fb \LaTeX}\\
...
%	Scientifically interested in \textsc{Computer Vision, Computational Geometry, Bioinformatics, Machine Learning, Genetic Algorithms}\interestsSpace	
        ...
        Get open sourced \comment{\href{https://github.com/petar-ivanov/}{GitHub profile} }\interestsSpace
